...
import { LogOut, Sun, Moon, Eye, ShieldAlert, Menu } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-xs block text-brand-muted font-medium">
              SaaS Multi-Tenant Quiz Platform
            </span>
          </div>
        </div>
          ...
          {user && (
            <div className="flex items-center gap-3 border-l border-brand-border pl-4">
              <div className="text-right hidden md:block">
                ...
                {profile && (
                  <span
                    className={`text-xs inline-block px-2 py-0.5 rounded-full font-bold ${
